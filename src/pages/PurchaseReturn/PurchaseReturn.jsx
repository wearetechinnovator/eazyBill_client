		...
		<>
			...
			<main id='main'>
				...
				<ConfirmModal
					...
					title={"Are you sure you want to delete the selected Purchase Return?"}
					fun={() => {
						removeData();
								...
								<table className='min-w-full bg-white' id='listQuotation' ref={tableRef}>
									<thead className='list__table__head'>
										<tr>
											...
											<th align='left'>Purchase Return Number</th>
									...
									<tbody>
										{
											billData.map((data, i) => {
												return <tr key={i}
													...
													<td align='left'>{new Date(data.returnDate).toLocaleDateString()}</td>
													<td align='left'>{data.purchaseReturnNumber}</td>
